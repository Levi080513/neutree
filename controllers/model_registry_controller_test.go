...
func TestModelRegistryController_Sync_PendingOrNoStatus(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Pending/NoStatus -> Deleted (with deletionTimestamp, disconnect success)",
			input: &v1.ModelRegistry{
				ID: 1,
				Metadata: &v1.Metadata{
					Name:              "test",
		...
		{
			name: "Pending/NoStatus -> Pending/NoStatus (with deletionTimestamp, disconnect failed)",
			input: &v1.ModelRegistry{
				ID: 1,
				Metadata: &v1.Metadata{
					Name:              "test",
...
func TestModelRegistryController_Sync_Connected(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Connected -> Deleted (with deletionTimestamp, disconnect success)",
			input: &v1.ModelRegistry{
				ID: 1,
				Metadata: &v1.Metadata{
					Name:              "test",
		...
		{
			name: "Connected -> Connected (with deletionTimestamp, disconnect failed)",
			input: &v1.ModelRegistry{
				ID: 1,
				Metadata: &v1.Metadata{
					Name:              "test",
...
func TestModelRegistryController_Sync_Failed(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Failed -> Deleted (with deletionTimestamp, disconnect success)",
			input: &v1.ModelRegistry{
				ID: 1,
				Metadata: &v1.Metadata{
					Name:              "test",
		...
		{
			name: "Failed -> Failed (with deletionTimestamp, disconnect failed)",
			input: &v1.ModelRegistry{
				ID: 1,
				Metadata: &v1.Metadata{
					Name:              "test",
